...
<html>
  <head>
    ...
    <link class="main-stylesheet" href="pages/css/themes/light.css"
  ...
  <body class="fixed-header dashboard menu-pin">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-header">
        <img src="assets/img/logohorizontal.png" alt="logo" class="brand" data-src="assets/img/logohorizontal.png" data-src-retina="assets/img/logohorizontal.png" width="200">
      </div>
        ...
        <ul class="menu-items">
          <li class="m-t-30 ">
            <a href="index.php" >INICIO              
              ...
              <li class="">
                <a href="promedia.php">Promedia</a>
         ...
         <div class=" container-fluid  container-fixed-lg footer">
          <div class="copyright sm-text-center">
            <p class="small no-margin pull-left sm-pull-reset">
             <img src="assets/img/logo.png" alt="logo" class="brand" data-src="assets/img/logo.png" data-src-retina="assets/img/logo.png" width="130"><br>
            ...
            <!-- END BREADCRUMB -->
                ...
                <div class="card card-transparent">
                  ...
                  <div class="card-block">
                    ...
                    <br>
                    <div>
                      <img src="assets/img/lab.jpg" alt="" data-src="assets/img/lab.jpg" data-src-retina="assets/img/lab.jpg" width="400">
