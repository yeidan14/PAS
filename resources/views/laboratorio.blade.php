@extends('principal')
                ...
                <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
                  <div class="inner">
                    <div class="pull-bottom bottom-left m-b-40 sm-p-l-15">
                      ...
                      <h1 class="text-white no-margin"><span class="semi-bold">PAS</span>| Labortatorios</h1>
                    </div>
                  </div>
                </div>
              </div>             
    ...
    <div class=" container-fluid  container-fixed-lg">
		...
		<div id="rootwizard" class="m-t-50">
			<!-- Nav tabs --><ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
				<li class="nav-item">
			...
			<div class="tab-content">
				<div class="tab-pane padding-20 sm-no-padding active slide-left" id="tab1">
                  ...
                  <div class="card-block">
                    ...
                    <br>
                    <div>
                      <img src="{{URL::asset('vista/assets/img/img_lab.jpg')}}"  width="400">
				...
				<div class="tab-pane slide-left padding-20 sm-no-padding" id="tab2">
                  ...
                  <div class="card-block">
                    ...
                    <br>
                    <div>
                      <img src="{{URL::asset('vista/assets/img/img_labr.jpg')}}" width="420">
