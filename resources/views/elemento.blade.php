            ...
            <!-- END BREADCRUMB -->
                ...
                <div class="card card-transparent">
                  <div class="card-header ">
                    <div class="card-title">Prestamo de elementos de la sala de movil
                    </div>
                  </div>
                  <div class="card-block">
                    ...
                    <br>
                    <div>
                      <img src="{{URL::asset('vista/assets/img/elemento.jpg')}}" alt="" data-src="{{URL::asset('vista/assets/img/elemento.jpg')}}" data-src-retina="{{URL::asset('vista/assets/img/elemento.jpg')}}" width="300">
                    ...
                    <form id="form-project" role="form" autocomplete="off" novalidate><br><br><br>
                      ...
                      <div class="form-group-attached">
                        <div class="form-group form-group-default">
                          <label>Seleccione Tipo de elementos :</label>
